...
if __name__ == "__main__":
    ...
    parser.add_argument("--images_dir", type=str, default="DIV2K/original/train", help="Path to input image directory. (Default: `DIV2K/original/train`)")
    ...
    parser.add_argument("--image_size", type=int, default=216, help="Low-resolution image size from raw image. (Default: 216)")
    parser.add_argument("--step", type=int, default=108, help="Crop image similar to sliding window.  (Default: 108)")
