...
parser.add_argument("--scale-factor", type=int, required=True, choices=[2, 4],
...
# Video write loader.
srgan_writer = cv2.VideoWriter(f"edsr_{args.scale_factor}x_{os.path.basename(video_name)}",
